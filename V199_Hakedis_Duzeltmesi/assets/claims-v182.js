...
function firmaWorkbook199(){
 ...
 captureFirmaReport199();
 const report=currentReport(),snapshot=period().snapshot191||report.snapshot||{},m=model(),currentRows=snapshot.firmaRows199||snapshot.rows||[];
 ...
 return api199.makeWorkbook(ExcelJS,{info,rows,previousPeriods,currentExtras:snapshot.extraRows||[],currentCuts:snapshot.cutRows||[]});
}
